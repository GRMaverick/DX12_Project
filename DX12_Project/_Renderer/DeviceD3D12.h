...
public:
	...
	bool CreateBufferResource(CommandList* _pCommandList, SIZE_T _sizeInBytes, SIZE_T _strideInBytes, void* _pData, IBufferResource** _ppResource);
	bool CreateVertexBufferResource(CommandList* _pCommandList, SIZE_T _sizeInBytes, SIZE_T _strideInBytes, void* _pData, VertexBufferResource** _ppResource);
	bool CreateIndexBufferResource(CommandList* _pCommandList, SIZE_T _sizeInBytes, SIZE_T _strideInBytes, void* _pData, IndexBufferResource** _ppResource);
