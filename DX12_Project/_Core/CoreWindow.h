...
public:
	...
	CoreWindow(HINSTANCE _hInstance, const wchar_t* _pClassName, const wchar_t* _pWindowName, bool _bFullscreen = false);
	~CoreWindow(void);

	static void SetMessageHandlerInstance(CoreWindow* _pWindow);
