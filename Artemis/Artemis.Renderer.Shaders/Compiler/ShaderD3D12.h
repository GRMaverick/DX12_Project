...
{
	class ShaderD3D12 final : public Artemis::Renderer::Interfaces::IShaderStage
	{
	public:
		ShaderD3D12( const void* _pBytecode, const size_t& _szBytecode, const ShaderType _type )
		{
			m_stType             = _type;
