...
{
	Texture2DResource::Texture2DResource( const wchar_t* _pWstrFilename, const bool _bIsDds, DescriptorHeap* _pTargetSrvHeap, ID3D12Device* _pDevice, CommandListDx12* _pCmdList, const wchar_t* _pDebugName )
	{
	...
	bool Texture2DResource::CreateFromDds( const wchar_t* _pWstrFilename, ID3D12Device* _pDevice, CommandListDx12* _pCmdList )
	{
	...
	bool Texture2DResource::CreateFromWic( const wchar_t* _pWstrFilename, ID3D12Device* _pDevice, CommandListDx12* _pCmdList )
	{
