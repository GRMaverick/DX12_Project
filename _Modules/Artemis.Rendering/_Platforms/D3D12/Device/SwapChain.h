...
namespace SysRenderer
{
	namespace D3D12
	{
		...
		public:
			...
			bool Initialise( Microsoft::WRL::ComPtr<ID3D12Device> _pDevice, Microsoft::WRL::ComPtr<IDXGIFactory5> _pFactory, CommandQueue* _pCommandQueue, UINT _backBuffers, DescriptorHeap* _pDescHeapRTV, DescriptorHeap* _pDescHeapDSV, Artemis::Core::GameWindow* _pWindow );
