...
#include "Artemis.Utilities/_Loaders/CLParser.h"
...
namespace SysRenderer
{
	...
	namespace D3D12
	{
		...
		IShaderStage* ShaderCompilerDXC::Compile( const char* _pFilename, const char* _pFunctionName, char* _pError )
		{
			...
			IShaderStage* pShader = new ShaderD3D12( pCompiledCode->GetBufferPointer(), pCompiledCode->GetBufferSize(), targetProfile[0] == L'v' ? IShaderStage::ShaderType::EVertexShader : IShaderStage::ShaderType::EPixelShader );
